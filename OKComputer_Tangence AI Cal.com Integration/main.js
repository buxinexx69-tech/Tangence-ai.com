...
// Form handling with Cal.com integration
function initFormHandling() {
    ...
    if (form) {
        form.addEventListener('submit', function(e) {
            ...
            submitButton.textContent = 'Loading Calendar...';
            submitButton.disabled = true;
            
            // Store form data for Cal.com booking
            window.demoFormData = data;
            
            // Hide form and show Cal.com booking widget
            setTimeout(() => {
                form.style.display = 'none';
                document.getElementById('cal-booking').style.display = 'block';
...
function sendDemoRequest(data) {
    ...
    console.log('Demo request initiated:', data);
    
    // Email content that would be sent:
    const emailContent = `
        NEW DEMO REQUEST INITIATED - Tangence.AI
        ...
        Status: Customer is now selecting time slot via Cal.com
        
        Action Required:
        - Monitor Cal.com for completed booking
        - Prepare demo materials
        - Follow up if booking is not completed within 1 hour
    `;
    
    // For demo purposes, we'll show this in console
    console.log('Initial notification email that would be sent to tanbossx@tangence-ai.com:');
